                    ...
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        ...
                        if (proposedIssuesList.length === 0) {
                            ...
                            for (let i = 0; i < proposedIssuesList.length; i++) {
                                stringList = stringList + "<tr  role='radiogroup'><td><a href='https://bugreports-test.qt.io/browse/" + proposedIssuesList[i].id + "' target='_blank'>" + proposedIssuesList[i].id + "</a></td><td>" + selectionList + "<select id=" + i + "s>" +
